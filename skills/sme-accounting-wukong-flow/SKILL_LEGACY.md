---
name: sme-accounting-wukong-flow-legacy
description: Legacy backup of the pre-V2 SME accounting skill. Keep for fallback, comparison, and recovery, but prefer SKILL.md as the primary entrypoint.
---

# SME Accounting Wukong Flow Legacy

This file preserves the pre-V2 skill as a fallback reference.
Use `SKILL.md` as the primary entrypoint.
