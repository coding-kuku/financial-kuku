---
name: sme-accounting-wukong-flow-v2
description: End-to-end bookkeeping and accounting decision skill for small and medium-sized enterprises using a structured workflow for inputs, preprocessing, classification, voucher generation, reconciliation, reporting, tax mapping, and Wukong system operations.
---

# SME Accounting Wukong Flow V2
